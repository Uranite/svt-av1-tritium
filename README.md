...
- Prioritize detail retention over artifact prevention (tune VQ):  
  `--tune 0 --crf xx (any, start with 35) --preset x (2 to 6 recommended)`
- Prioritize film grain retention (tune Film Grain):  
  `--tune 4 --crf xx (20 to 40 recommended, start with 30) --preset x (2 recommended)`
- Still image coding (tune IQ + AVIF):  
  `--tune 3 --crf xx (any, start with 30) --preset x (2 to 6 recommended) --avif`
