...
| **Tune**                         | --tune                      | [0-4]                          | 0           | Optimize the encoding process for different desired outcomes [0 = VQ, 1 = PSNR, 2 = SSIM, 3 = Film Grain, 4 = Still Picture] |
...
| **NoiseAdaptiveFiltering**      | --noise-adaptive-filtering      | [0-4]      | 0           | Controls noise detection which disables CDEF/restoration when noise level is high enough, default is 0 to make tune 0/3 more balanced [0: off, 1: both CDEF and restoration noise-adaptive filtering are on, 2: default tune behavior, 3: noise-adaptive CDEF only, 4: noise-adaptive restoration only] |
