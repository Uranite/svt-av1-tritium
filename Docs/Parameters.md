...
| **NoiseAdaptiveFiltering**      | --noise-adaptive-filtering      | [0-4]      | 0           | Controls noise detection which disables CDEF/restoration when noise level is high enough, default is 0 to make tune 0 more balanced [0: off, 1: both CDEF and restoration noise-adaptive filtering are on, 2: default tune behavior, 3: noise-adaptive CDEF only, 4: noise-adaptive restoration only] |
